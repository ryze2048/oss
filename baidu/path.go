...
// GetBasePath
// suffix .png|jpg....
func (b *BaiduOSS) GetBasePath(suffix string) (path string) {
	return filepath.Join(b.BasePath, time.Now().Format("2006-01-02"), fmt.Sprintf("%s%s", common.GenerateRandomFilename(16), suffix))
}
